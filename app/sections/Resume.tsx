...
const Resume = () => {
  return (
    <div
      id="resume"
      className="max-w-[1000px] text-left pt-10 sm:text-xl font-extralight"
    >
      <h1 className="text-2xl font-normal mb-6 text-[#eff876]">Resume</h1>
      <div className="flex flex-col sm:flex-row">
        <div className="sm:mr-10" id="mainresume">
          <h3 className="text-[1.3rem] text-[#ffffff] font-normal border-b border-1 w-max border-white mt-4">
            Education
          </h3>
          ...
          <ul className="educationlist list-disc list-inside">
            <li className="pr-2 ml-2 text-left text-[1rem] sm:text-[1.2rem]">
              Master&apos;s student
            </li>
            <li className="pr-2 ml-2 text-left text-[1rem] sm:text-[1.2rem]">
          ...
          <h3 className="text-xl mt-6 text-[#eff876]">
          ...
          <h3 className="text-xl mt-6 text-[#eff876]">
            Helsinki school of natural sciences (high school)
          </h3>
          <p className="text-sm font-normal text-gray-500">
            Sep. 2015 - Jun. 2018
          </p>
          ...
          <h3 className="resumehead text-[1.3rem] text-[#ffffff] font-normal border-b border-1 w-max border-white mt-4">
            Experience
          </h3>
        ...
        <div
          className="resumediv"
          id="secondresume text-[1rem] sm:text-[1.2rem]"
        >
          <h3 className="text-[1.3rem] text-[#ffffff] font-normal border-b border-1 w-max border-white mt-10 sm:mt-4 mb-1">
            Skills and familiar tools
          </h3>
          <ul className="list-disc list-inside max-w-fit">
            <li className="skill text-[1rem] sm:text-[1.2rem]">
              Web software development (Node, React, ThreeJS, Vite.js, Next.js
              etc.)
            </li>
          ...
          <h3 className="text-[1.3rem] text-[#ffffff] font-normal border-b border-1 w-max border-white mt-4 mb-1">
            Languages
          </h3>
