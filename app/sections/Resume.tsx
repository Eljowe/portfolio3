...
const Resume = () => {
  return (
    <div id="resume" className="max-w-[1000px] pb-20 pt-10 text-left font-extralight sm:text-xl">
      <h1 className="text-theme-main mb-6 text-2xl font-normal">Resume</h1>
      <div className="flex flex-col sm:flex-row">
        <div className="sm:mr-10" id="mainresume">
          <h3 className="resumehead border-1 border-theme-main text-theme-main mt-4 w-full border-b text-[1.3rem] font-normal">
            Experience
          </h3>
          <h3 className="text-theme-second mt-2 text-xl italic">Accenture</h3>
          ...
          <h3 className="text-theme-second mt-2 text-xl italic">Vaisala Oyj</h3>
          ...
          <h3 className="text-theme-second mt-2 text-xl italic">Aalto University</h3>
          ...
          <h3 className="text-theme-second mt-6 text-xl italic">University of Helsinki</h3>
          ...
          <h3 className="text-theme-second mt-6 text-xl italic">Helsinki school of natural sciences (high school)</h3>
        ...
        <div className="resumediv" id="secondresume text-[1rem] sm:text-[1.2rem]">
          <h3 className="resumehead border-1 border-theme-main text-theme-main mt-4 w-full border-b text-[1.3rem] font-normal sm:mt-4">
