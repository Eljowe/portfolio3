  ...
  return (
    <main className="page flex min-h-screen flex-col items-center justify-between text-white">
      ...
      <section id="home" className='min-h-screen flex'>
          ...
          <div ref={sphere1} id='spherediv' className="fixed pointer-events-none top-1/2 left-[70%] w-[70vh] h-[70vh] sm:left-[70%] sm:w-[80vh] sm:h-[80vh] transform -translate-y-1/2 opacity-70 z-0">
            <Sphere parent="spherediv"/>
          </div>
          <div ref={sphere2} id='spherediv2' className="fixed pointer-events-none top-1/4 right-[30%] w-[35vh] h-[35vh] sm:right-[45%] sm:w-[30vh] sm:h-[30vh] transform -translate-y-1/2 opacity-50 z-0">
            <Sphere parent="spherediv2"/>
          </div>
          <div ref={sphere3} id='spherediv3' className="fixed pointer-events-none top-2/3 right-[40%] w-[90vh] h-[90vh] sm:right-[50%] sm:w-[60vh] sm:h-[60vh] sm:top-[90vh] transform -translate-y-1/2 opacity-50 z-0">
